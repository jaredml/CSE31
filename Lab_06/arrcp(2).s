...
loop:   lw      $v1, 0($a0)     # read next word from source
        ...
        addiu   $a0, $a0, 4     # advance pointer to next source problem 1
        addiu   $a1, $a1, 4     # advance pointer to next dest problem 2
        beq     $v1, $zero, loopend # loop if word copied not zero problem 3
        addiu   $v0, $v0, 1     # increment count words copied
        j loop # jumps to the loop end problem 4
